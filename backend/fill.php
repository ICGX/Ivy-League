...
<form action="add.php" method="POST" id="myform">
  ...
  First answer:
  <input type="text" name="1a"><br>
  <br>
  
  Second Question:
  <input type="text" name="2q"><br>
  Second Answer:
  <input type="text" name="2a"><br>
    <br>

  Third Question:
  <input type="text" name="3q"><br>
  Third Answer:
  <input type="text" name="3a"><br>
    <br>

  Fourth Question:
  <input type="text" name="4q"><br>
  Fourth Answer:
  <input type="text" name="4a"><br>
    <br>

  Fifth Question:
  <input type="text" name="5q"><br>
  Fifth Answer:
  <input type="text" name="5a"><br>
    <br>

  Sixth Question:
  <input type="text" name="6q"><br>
  Sixth Answer:
  <input type="text" name="6a"><br> 
    <br>
